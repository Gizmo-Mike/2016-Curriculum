...
GizmoGardenPixels lights(64, NeoPixelPin);
...
char showMode = 0;
int showLoopDelay = 1000;
unsigned long showLoopGoTime = 0;
...
void loop()
{
  ...
  if (showMode > 0 && millis() >= showLoopGoTime)
  {
    beepParty();
    showLoopGoTime = millis() + showLoopDelay;
  }
}
